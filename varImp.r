...
model_demsat <- train(satisfactdemocW0~., data=attitude_demsat, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_eu <- train(euintegrationW2~., data=attitude_eu, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_orderdem <- train(order_democrW2~., data=attitude_orderdem, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_elect <- train(democracy_freelectW2~., data=attitude_elect, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_obed <- train(democracy_obedienceW2~., data=attitude_obed, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_clima <- train(climaterealW2~., data=attitude_clima, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_islam <- train(issueopinions_islam1W1~., data=attitude_islam, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_job <- train(immprobs_jobsW0~., data=attitude_job, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_crime <- train(immprobs_crimeW0~., data=attitude_crime, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_gov <- train(leftpopattid_govredW2~., data=attitude_gov, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_bus <- train(leftpopattid_bigbusW2~., data=attitude_bus, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_ben <- train(leftpopattid_socbenlazyW2~., data=attitude_ben, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_lr <- train(leftrightW0~., data=attitude_lr, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_pol <- train(polinterestW0~., data=attitude_pol, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_police <- train(trustinst_policeW0~., data=attitude_police, method="lm", preProcess="scale", trControl=control)
...
# the model
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model_parl <- train(trustinst_nationparlW0~., data=attitude_parl, method="lm", preProcess="scale", trControl=control)
...
ggplot(data_long, aes(x = Rank, y = Attitude, fill = Category, alpha = -Rank)) +
...
htmlwidgets::saveWidget(as_widget(p), "varImp.html")
