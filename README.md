...
- [Plot](https://htmlpreview.github.io/?https://github.com/bartaz/impress.js/blob/master/varImp.html) with Variable Importance Rank of domain categories for each political attitude.
